class ContactosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contacto.save
        ...
        #else
         format.html { redirect_to new_contacto_path , notice: 'Contacto was successfully created.' }
        format.json { render :show, status: :created, location: @contacto }
        #end
  ...
  private
    ...
    def contacto_params
      params.require(:contacto).permit(:nombre_contact, :apellido_contact, :email_contact, :telef_contact, :consulta_contact)
    end
end
